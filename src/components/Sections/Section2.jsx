...
export default function Section1() {
  return (
    <div className="cardBenefits h-full flex">
      ...
      <div className="featureText md:hidden p-5 m-12 absolute flex items-center justify-center leading-relaxed bottom-50 text-2xl sm:text-4xl text-left bg-red-500 bg-opacity-20 backdrop-blur-md font-light z-1">
        Stucture your course fast and with ease.<br></br>
        Create reusable sequenzes.<br></br>
        Keep an eye onto the golden thread.<br></br>
        Prepare well structured classes. <br></br>
