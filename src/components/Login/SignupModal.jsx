    ...
    <Transition.Root show={SignupModalOpen} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="relative inline-block align-bottom bg-slate-500 bg-opacity-50 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
